...
type Process struct {
	...
	CreatedAt uint64 `field:"created_at,ResolveProcessCreatedAt" msg:"-"` // Timestamp of the creation of the process
	...
	Argv0         string   `field:"argv0,ResolveProcessArgv0:100" msg:"argv0"`                                                                                                                 // First argument of the process
	...
	Envs          []string `field:"envs,ResolveProcessEnvs:100" msg:"envs,omitempty"`                                                                                                          // Environment variable names of the process
	Envp          []string `field:"envp,ResolveProcessEnvp:100" msg:"-"`                                                                                                                       // Environment variables of the process
	EnvsTruncated bool     `field:"envs_truncated,ResolveProcessEnvsTruncated" msg:"envs_truncated"`                                                                                           // Indicator of environment variables truncation
...
type FileFields struct {
	...
	User  string `field:"user,ResolveFileFieldsUser" msg:"user,omitempty"`            // User of the file's owner
	GID   uint32 `field:"gid" msg:"gid"`                                              // GID of the file's owner
	Group string `field:"group,ResolveFileFieldsGroup" msg:"group,omitempty"`         // Group of the file's owner
...
type ProcessContext struct {
	...
	Ancestor *ProcessCacheEntry `field:"ancestors,,ProcessAncestorsIterator" msg:"ancestor,omitempty"`
}
...
type SyscallEvent struct {
	Retval int64 `field:"retval" msg:"retval,omitempty"` // Return value of the syscall
	Async  bool  `field:"async" msg:"async,omitempty"`   // True if the syscall was asynchronous
}
