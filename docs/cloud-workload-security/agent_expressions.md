...
| `exit.cap_effective` | int | Effective capability set of the process |
| `exit.cap_permitted` | int | Permitted capability set of the process |
...
| `exit.file.mode` | int | Mode/rights of the file |
...
| `exit.file.rights` | int | Mode/rights of the file |
